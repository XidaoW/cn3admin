...
public class fimportCSVpaperToAdmin {
		...
		try {
			...
			while(rs.next()){
				...
				if(rsContent.next()){
					...
					String insertMapContentSql = "INSERT INTO mapcontent_admin (adminContentID, testingContentID) VALUES ("+adminContentID+","+contentID+")";
