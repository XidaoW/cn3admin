...
public class importCSVpaperToAdmin {
	...
	public static void main(String[] args) {
		...
		String sql = "SELECT * FROM admin_content_copy";
//		String sql = "SELECT * FROM cn3Testing_new_dump.umap_lifelong_2013";
		...
		try {
			...
			while(rs.next()){
				String adminContentID = rs.getString("id");
				String title = rs.getString("title");
				String _authors = rs.getString("author_list");//rs.getString("authors");
				String track = rs.getString("contentTrack");//rs.getString("track");
				String Category = rs.getString("contentType");//rs.getString("category");
				...
				sql = "INSERT INTO content " +
						"(title,abstract,conferenceID,contentType,contentTrack) " +
						"VALUES (?,?,?,?,?)";	        
				...
				if(rsContent.next()){
					...
					String insertMapContentSql = "INSERT INTO mapcontent_admin (adminContentID, testingContentID, adminConferenceID) VALUES ("+adminContentID+","+contentID+","+conferenceID_admin+")";
					System.out.println(insertMapContentSql);		
					conn.executeUpdate(insertMapContentSql);
					/*
